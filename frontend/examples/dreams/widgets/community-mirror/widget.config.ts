...
const config: WidgetConfig = {
  ...
  tool: {
    ...
    description:
      "Show anonymized community dream snippets that match the user's symbol. snippets must come directly from community_dreams search results — use the actual returned content and scores. [Layout: third width, medium height]",
    parameters: {
