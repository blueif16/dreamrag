...
const config: WidgetConfig = {
  ...
  tool: {
    ...
    description:
      "Show past dream echoes. Populate from search_dreams results against user_{id}_dreams namespace — use the actual returned content as echoes, not invented text. [Layout: third width, compact height]",
    parameters: {
